...
RIM_OVERFS_MODE=1 RIM_NO_NVIDIA_CHECK=1 ./runimage sh -c "$(command -v run_install > /dev/null 2>&1 || declare -f run_install); run_install"
...
./pelf --add-appdir ./AppDir \
	--appbundle-id="com.valvesoftware.Steam-$(date +%d_%m_%Y)-xplshn" \
